		...
		<BaseLayout>
			<div className="w-full h-full relative">
				...
				<div className="absolute inset-0">
					<div>
						<img
							src="/images/background/landing-background.webp"
							alt="background"
							className="shadow-img max-h-screen mx-auto"
						/>
					</div>
					<div className="flex flex-col h-full absolute inset-0">{children}</div>
				</div>
			</div>
		</BaseLayout>
	);
