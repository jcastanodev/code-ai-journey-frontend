...
export function SignInForm({ unauthorizedRoute }: SignInFormProps) {
	...
	return (
		<form
			...
			className="flex flex-col gap-2 mx-auto my-auto text-black bg-transparent dark:text-white"
		>
			<div className="container flex p-4 flex-col gap-4 my-2 bg-white/90 dark:bg-white/10">
				<Controller
					control={control}
					name="email"
					defaultValue=""
